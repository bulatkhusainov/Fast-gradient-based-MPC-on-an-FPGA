...
#define x_in_IN_DEFINED_MEM_ADDRESS 0
#define y_out_OUT_DEFINED_MEM_ADDRESS (X_IN_IN_LENGTH)*4
...
int main()
{
	...
	memory_inout = (data_t_memory *)malloc((X_IN_IN_LENGTH+Y_OUT_OUT_LENGTH)*4); //malloc size should be sum of input and output vector lengths * 4 Byte
