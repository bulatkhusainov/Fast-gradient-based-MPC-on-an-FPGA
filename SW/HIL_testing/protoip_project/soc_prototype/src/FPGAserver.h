...
#define X_IN_IN_VECTOR_LENGTH 5
#define Y_OUT_OUT_VECTOR_LENGTH 5

//SOC interface arrays lengths:
#define SOC_X_HAT_IN_VECTOR_LENGTH 20

#define SOC_U_OPT_OUT_VECTOR_LENGTH 100
////////////////////////////////////////////////////////////
//FPGA vectors memory maps
#define x_in_IN_DEFINED_MEM_ADDRESS 33554432
#define y_out_OUT_DEFINED_MEM_ADDRESS 33554452
