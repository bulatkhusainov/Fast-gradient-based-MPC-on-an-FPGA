...
u_opt_soc_interface = strcat('u_opt:',num2str(5),':float'); % assume all optimization variables go here


%make_template('type','SOC','project_name','my_project0','input',x_in_interface,'output',y_out_interface,'soc_input',x_hat_soc_interface,'soc_output',u_opt_soc_interface);

ip_design_build('project_name','my_project0', 'input', x_in_interface, 'output', y_out_interface);
