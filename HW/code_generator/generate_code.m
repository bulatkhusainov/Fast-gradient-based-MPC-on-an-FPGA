...
if not( exist('current_design','var') && any(strcmp('N',fieldnames(current_design))) ); current_design.N = 7; end;  % horizon length
current_design.n_bits_integer = 5; % number of integer bits
current_design.n_bits_fraction = 5; % number of fraction bits 
